...
// 自定义结果类（与之前相同）
class StudentActivityResult implements Serializable {
    ...
    public StudentActivityResult() {}

    public StudentActivityResult(String studentId, String studentName, String classId, String windowStart, String windowEnd, int totalScore, int totalTimeCost, int activityCount) {
